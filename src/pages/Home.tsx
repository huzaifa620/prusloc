  ...
  return (
    <div className="w-full">
      ...
      {links.slice(1).map((el)=>(
        <div className="relative backdrop-blur from-white via-red-50 to-cyan-100 bg-gradient-to-br w-64 h-48 justify-self-center flex justify-center items-center rounded-md shadow-md col-span-1 px-4 py-2 group">
